...
<head>
        ...
        <meta name="keywords" content="KITWASCO" />
        <meta name="description" content="KITWASCO">
                        ...
                        <div class="header-row">
                            <div class="header-column">
                                <div class="header-log">
                                    <a href="index.html">
                                        <img alt="Porto" width="80" height="80" src="<?php echo base_url();?>assets/img/kitwasco.png">
                                    </a>
                                </div>
                            </div>
                            <div class="header-column">
